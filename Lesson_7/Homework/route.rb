...
protected
  def validate!
    ...
    raise "Start station name must be between 4 and 30 characters long" if invalid_length?(initial_point.name)
    raise "End station name must be between 4 and 30 characters long" if invalid_length?(final_point.name)
  end
